...
const ProductsScreen = () => {
  ...
  const columns = [
    {
      title: t("screens.products.productId"),
      dataIndex: "productId",
      key: "productId",
    },
    { title: t("screens.products.name"), dataIndex: "name", key: "name" },
    { title: t("screens.products.unit"), dataIndex: "unit", key: "unit" },
    {
      title: t("screens.products.quantity"),
      dataIndex: "quantity",
      key: "quantity",
    },
    {
    ...
    {
      title: t("screens.products.discount"),
      dataIndex: "discount",
      key: "discount",
    },
    {
