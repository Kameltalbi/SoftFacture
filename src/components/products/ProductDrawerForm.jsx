  ...
  return (
    ...
    >
      <Form form={form} layout="vertical" onFinish={handleFinish}>
        <Form.Item name="productId" label={t("screens.products.productId")}>
          <Input
        ...
        <Form.Item
          name="unit"
          label={t("screens.products.unit")}
          rules={[
            { required: true, message: t("screens.products.unitRequired") },
          ]}
        >
          <Input placeholder="e.g. pcs, hrs" />
        </Form.Item>
        ...
        <Form.Item name="quantity" label={t("screens.products.quantity")}>
        ...
        <Form.Item name="discount" label={t("screens.products.discount")}>
          <InputNumber style={{ width: "100%" }} min={0} step={0.01} />
        </Form.Item>
        ...
        <Form.Item>
          <Button type="primary" htmlType="submit" style={{ backgroundColor: PRIMARY }}>
